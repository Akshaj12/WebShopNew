...
namespace webshop.Data
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
          ...
          new Product() { Id = 6, Name = "Sunglasses", Price = 1200, Image = "Sunglasses/Gucci.jpg", Image1 = "Sunglasses/Raybon.jpg", Image2 = "Shoes/RaybonNew.jpg", Description = "better quality!", ParentCategoryId = 2 },
